...
let cat1 = new Cat('Swift', 4, 'black/white');
...
//Code Here
let phone1 = new Phone('Apple','iPhone',516,'black',1000)
let phone2 = new Phone('Samsung','Galaxy',300,'silver',750)
let phone3 = new Phone('Motorola','Razr',50,'pink',300)
...
//Code Here
let myFirstVehicle = new Vehicle(4, 'red', 20,000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1,'black',5,'Yamaha',true)
...
//Code Here
let myFirstBoat = new Boat(4,'white', 1000,'Slice of Life','yacht', false)
/*
